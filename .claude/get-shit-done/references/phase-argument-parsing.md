...
```bash
PHASE_INFO=$(node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
