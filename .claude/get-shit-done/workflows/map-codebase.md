...
```bash
INIT=$(node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
