...
- **Global scope**: `/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/notes/`)
...
2. Glob `/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.claude/notes/` — works in any directory
