...
import { CursorAgentLogView } from './renderers/CursorAgentLogView'
import { ClaudeCodeLogView } from './renderers/ClaudeCodeLogView'
import { CodexLogView } from './renderers/CodexLogView'
import { GeminiLogView } from './renderers/GeminiLogView'
import { OpencodeLogView } from './renderers/OpencodeLogView'
import { UnknownToolLogView } from './renderers/UnknownToolLogView'

function renderToolLogView(toolId: string, logs: LogMsg[]): React.ReactNode {
  switch (toolId) {
    case 'cursor-agent':
      return <CursorAgentLogView logs={logs} />
    case 'claude-code':
      return <ClaudeCodeLogView logs={logs} />
    case 'codex':
      return <CodexLogView logs={logs} />
    case 'gemini-cli':
      return <GeminiLogView logs={logs} />
    case 'opencode':
      return <OpencodeLogView logs={logs} />
    default:
      return <UnknownToolLogView logs={logs} />
  }
}
