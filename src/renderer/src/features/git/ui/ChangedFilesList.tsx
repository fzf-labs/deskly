import { Check, Circle, File, FileEdit, FilePlus, FileQuestion, FileX } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {dirPath && <div className="text-muted-foreground truncate text-xs">{dirPath}</div>}
      </div>
      <button
        onClick={(event) => {
