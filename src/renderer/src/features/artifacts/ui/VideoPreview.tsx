...
import { getVideoMimeType, isRemoteUrl, MAX_PREVIEW_SIZE, openFileExternal } from '../model/utils'
  ...
  return (
    <div className="bg-muted/30 flex h-full flex-col items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        ...
        <div className="text-muted-foreground mt-3 text-center text-sm">{artifact.name}</div>
      </div>
    </div>
  )
}
