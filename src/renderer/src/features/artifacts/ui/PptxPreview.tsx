...
import type { PptxSlide, PreviewComponentProps } from '../model/types'
  ...
  if (loading) {
    return (
      <div className="bg-muted/20 flex h-full flex-col items-center justify-center p-8">
        ...
        <p className="text-muted-foreground mt-4 text-sm">Loading presentation...</p>
      </div>
    )
  }
        ...
        <div className="bg-background relative aspect-[16/9] w-full max-w-4xl overflow-hidden rounded-lg shadow-xl">
          {slide.imageUrl ? (
            ...
            <div className="flex h-full w-full flex-col p-8">
              {slide.title && (
                <h2 className="text-foreground mb-6 text-2xl font-bold">{slide.title}</h2>
              )}
