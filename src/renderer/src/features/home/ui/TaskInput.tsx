...
export function TaskInput() {
  ...
  return (
    <div className="flex w-full max-w-3xl flex-col items-center gap-6">
      {/* Title */}
      <h1 className="text-foreground font-serif text-4xl font-medium">{t.home.welcomeTitle}</h1>
        ...
        {quickActions.map((action) => (
          <button
            ...
            className={cn(
              ...
              isRunning ? 'cursor-not-allowed opacity-50' : 'hover:bg-accent hover:text-foreground'
            )}
          >
            {action.icon}
