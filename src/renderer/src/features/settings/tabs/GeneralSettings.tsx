...
export function GeneralSettings({ settings, onSettingsChange }: SettingsTabProps) {
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-2">
        <label className="text-foreground block text-sm font-medium">{t.settings.language}</label>
        <Select
          value={language}
      ...
      <div className="flex flex-col gap-3">
        <label className="text-foreground block text-sm font-medium">{t.settings.appearance}</label>
          ...
          {THEME_OPTIONS.map((option) => (
            <button
              ...
              className={cn(
                ...
                theme === option.id ? 'focus-visible:ring-primary/30' : 'focus-visible:ring-ring'
              )}
            >
              <div
                className={cn(
