import type { MCPServerStdio, MCPServerUI } from '../types'
...
export const extractMcpServers = (value: unknown): MCPServerRecord => {
  ...
  const direct =
    (value as { mcpServers?: unknown; mcp_servers?: unknown }).mcpServers ||
...
export const getProjectMcpConfigPath = (projectPath: string, cliId?: string): string => {
