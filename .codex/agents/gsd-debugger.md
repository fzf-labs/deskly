...
```bash
INIT=$(node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/fuzhifei/code/go/src/github.com/fzf-labs/deskly/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
